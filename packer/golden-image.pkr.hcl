...
variable "proxmox_vmid" {
  type        = string
  description = "The specific VMID from transmission inventory. Generated by script"
}
...
source "proxmox-iso" "debian-base" {
  ...
  boot_iso {
    type         = "scsi"
    iso_file     = "truenas-nfs:iso/pbx.iso"
    unmount      = true
  }
...
build {
  sources = ["proxmox-iso.debian-base"]
